...
import 'package:almarsa/screens/electronics/screen/electronics_screen.dart';
...
import 'package:almarsa/screens/wish_list/screen/wish_list_screen.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.electronics,
      page: () => ElectronicsScreen(),
    ),
    GetPage(
